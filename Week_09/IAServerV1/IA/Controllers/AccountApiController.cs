...
namespace IA.Controllers.Api
{
    ...
    public class AccountController : ApiController
    {
        ...
        /// <summary>
        /// Detailed information about a user account's settings
        /// </summary>
        /// <param name="returnUrl">Return URL</param>
        /// <param name="generateState">True or false</param>
        /// <returns>Detailed data</returns>
        [Route("ManageInfo")]
        ...
        /// Change password
        /// </summary>
        /// <param name="model">Old and new password data</param>
        /// <returns>HTTP 200 or an error response</returns>
        ...
        /// <summary>
        /// Set/configure a new password
        /// </summary>
        /// <param name="model">New password for the current authenticated user</param>
        /// <returns>HTTP 200 or an error response</returns>
        [Route("SetPassword")]
        ...
        */
        ...
        /// <summary>
        /// Remove an external login from the current authenticated user
        /// </summary>
        /// <param name="model">External login data</param>
        /// <returns>HTTP 200 or an error response</returns>
        [Route("RemoveLogin")]
        ...
        */
        ...
        /// <summary>
        /// List of external logins for the current authenticated user
        /// </summary>
        /// <param name="returnUrl">Return URL</param>
        /// <param name="generateState">True or false</param>
        /// <returns>Detailed data</returns>
        ...
        /// </summary>
        /// <param name="model">Data package that includes an identifier, password, etc.</param>
        /// <returns>HTTP 200 or an error response</returns>
        [AllowAnonymous]
        [Route("Register")]
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                foreach (var cc in model.CustomClaims)
                {
